            ...
            <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                <div class="product-categori">
                    <div class="search-product">
                        <form action="#">
                            <input aria-label="search" class="form-control" placeholder="Search here..." type="text">
                    ...
                    <div class="filter-price-left">
                        ...
                        <div class="price-box-slider">
                            ...
                            <p>
                                <input aria-label="amount" type="text" id="amount" readonly style="border:0; color:#fbb714; font-weight:bold;">
                    ...
                    <div class="product-item-filter row">
                        <div class="col-12 col-sm-8 text-center text-sm-left">
                            <div class="toolbar-sorter-right">
                                <span>Sort by </span>
                                <select aria-label="basic" id="basic" class="selectpicker show-tick form-control" data-placeholder="$ USD">
                    ...
                    <div class="row product-categorie-box">
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                <div class="row">
                                    <myC:forEach var="products" items="${products}">
                                        ...
                                    </myC:forEach>
