        ...
        <div class="row">
                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input aria-label="text" type="text" class="form-control" id="cc-cvv" placeholder="" required>
                                <div class="invalid-feedback"> Security code required </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="payment-icon">
                                    <ul>
                                        <li><img class="img-fluid" src="${resources}images/payment-icon/1.png" alt=""></li>
                                        <li><img class="img-fluid" src="${resources}images/payment-icon/2.png" alt=""></li>
                                        <li><img class="img-fluid" src="${resources}images/payment-icon/3.png" alt=""></li>
                                        <li><img class="img-fluid" src="${resources}images/payment-icon/5.png" alt=""></li>
                                        <li><img class="img-fluid" src="${resources}images/payment-icon/7.png" alt=""></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-6 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 d-flex shopping-box"> <a href="<c:url value="/shop/checkout"/>" class="ml-auto btn hvr-hover">Place Order</a> </div>
                </div>
            </div>
        </div>
