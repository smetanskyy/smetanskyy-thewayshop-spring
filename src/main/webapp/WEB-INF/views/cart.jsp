...
<div class="cart-box-main">
    <div class="container">
                ...
                <div class="table-main table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="quantity-box"><input aria-label="number" type="number" size="4" value="1" min="0" step="1" class="c-input-text qty text"></td>
                            <td class="total-pr">
                                <p>$ 80.0</p>
                            </td>
                            <td class="remove-pr">
        ...
        <div class="row my-5">
            ...
            <div class="col-12 d-flex shopping-box"><a href="<c:url value="/shop/checkout"/>" class="ml-auto btn hvr-hover">Checkout</a> </div>
        </div>
